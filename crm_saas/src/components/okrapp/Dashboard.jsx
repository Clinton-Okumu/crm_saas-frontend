...
const DashboardSection = () => {
  ...
  return (
    <div className="p-6 bg-white-50"> {/* Removed min-h-screen and flex flex-col */}
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="flex flex-col justify-center items-center p-6 bg-white border-4 border-red-500 shadow-lg rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800">Overdue Objectives</h3>
      ...
      {/* Line Chart */}
      <div className="w-full h-64 md:h-96"> {/* Adjusting height for the chart */}
