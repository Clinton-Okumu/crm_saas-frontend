    ...
    <div className="p-6 bg-white/50 h-screen overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex space-x-4">
          <Link to="/clients" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600">
            Clients
          </Link>
          <Link to="/accounts" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600">
            Accounts
          </Link>
          <Link to="/expenses" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600">
            Expenses
          </Link>
          <Link to="/sales" className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-600">
            Sales
          </Link>
        </div>
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="flex flex-col justify-center items-center p-6 bg-white border-4 border-blue-300 shadow-lg rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800">Total Expenses</h3>
      ...
      <section className="mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-full" style={{ height: '50vh', width: '100%' }}>
